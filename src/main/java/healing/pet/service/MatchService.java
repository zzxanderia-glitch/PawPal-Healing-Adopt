...
import main.java.healing.pet.dao.PetDAOImpl;
...
public class MatchService {
     ...
     */
    public List<Animal> match(healing.pet.service.UserPreferences preferences) throws SQLException {
     ...
     * 计算单只宠物的契合度得分
     */
    private int calculateScore(Animal pet, healing.pet.service.UserPreferences prefs) {
        int score = 0;
    ...
    public static void main(String[] args) throws SQLException {
        ...
        healing.pet.service.UserPreferences prefs = new healing.pet.service.UserPreferences("温顺", "公寓", "多");
